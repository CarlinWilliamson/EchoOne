...
if __name__ == '__main__':
	try:
		...
		print("Error: Took too long to find an element\n  This could be because the internet connection is too slow\n  or the name, class name, id or xpath has changed for one of the elements")
